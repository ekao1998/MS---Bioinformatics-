...
int main(int argc, char **argv){
	...
	// get the rank = this process's number(range from 0 to nprocs-1)
	...
	MPI_Allreduce(&partial_sum, &total_sum, 1, MPI_LONG_LONG_INT, MPI_SUM, MPI_COMM_WORLD);
	cout<< "Total sum of the array elements is "<< total_sum<<" in rank "<<rank<<endl;
